    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Booking cancelled successfully'), backgroundColor: AppTheme.successColor),
        );
      }
    } catch (e) {
      if (mounted) {
...
Time Slot: ${DateFormat('hh:mm a').format(_appointment!.date)}
...
'''.trim();
                            ...
                            Row(
                              children: [
                                if (_appointment!.status == AppointmentStatus.upcoming || _appointment!.status == AppointmentStatus.inQueue)
                                  Expanded(
