                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      color: isActive ? AppTheme.getCardColor(context) : AppTheme.getCardColor(context).withOpacity(0.6),
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(
                                          ...
                                          color: isActive ? AppTheme.getTextColor(context) : AppTheme.getMutedTextColor(context),
                                        ),
                                      ),
                                      if (!isActive) ...[
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: AppTheme.getMutedTextColor(context).withOpacity(0.15),
                                            borderRadius: BorderRadius.circular(4),
                                          ),
                                          child: Text('Inactive', style: TextStyle(fontSize: 10, color: AppTheme.getMutedTextColor(context), fontWeight: FontWeight.w600)),
                                        ),
                                      ],
                                    ],
                                  ),
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(fontSize: 13, color: AppTheme.getMutedTextColor(context)),
                                  ),
                                ],
                              ),
                            ),
  ...
  Widget _buildInfoChip(IconData icon, String text) {
    return Row(
      ...
      children: [
        ...
        Text(text, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: AppTheme.getMutedTextColor(context))),
      ],
    );
  }
}
