                      ...
                      if (_queue.isEmpty)
                        Center(
                          child: Padding(
                            ...
                            child: Text('No active queue tokens right now.', style: TextStyle(color: AppTheme.getMutedTextColor(context))),
                          ),
                        ),
                      ...
                      ..._queue.where((q) => q.status == AppointmentStatus.inQueue || q.status == AppointmentStatus.serving).map((item) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            color: isServing ? AppTheme.successColor.withOpacity(0.05) : AppTheme.getCardColor(context),
                            borderRadius: BorderRadius.circular(14),
                            border: Border.all(
                              color: isServing ? AppTheme.successColor.withOpacity(0.2) : AppTheme.getBorderColor(context),
                            ),
                          ),
                          child: Column(
                            children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          item.providerName,
                                          style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: AppTheme.getTextColor(context)),
                                          maxLines: 1,
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(fontSize: 12, color: AppTheme.getMutedTextColor(context)),
                                        ),
                                      ],
                                    ),
                                  ),
