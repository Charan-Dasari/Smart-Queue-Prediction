...
class _AnalyticsDashboardScreenState extends State<AnalyticsDashboardScreen> {
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          ...
                          color: _selectedPeriod == 0 ? Colors.white : AppTheme.getMutedTextColor(context),
                        ),
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 12,
                          fontWeight: FontWeight.w600,
                          color: _selectedPeriod == 1 ? Colors.white : AppTheme.getMutedTextColor(context),
                        ),
                      ),
                    ),
                  ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Peak Hours',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: AppTheme.getTextColor(context)),
            ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  '${(value * 100).toInt()}%',
                                  style: TextStyle(fontSize: 9, fontWeight: FontWeight.w600, color: AppTheme.getMutedTextColor(context)),
                                ),
                                ...
                                Text(
                                  ...
                                  style: TextStyle(fontSize: 9, color: AppTheme.getMutedTextColor(context)),
                                ),
                              ],
                            ),
                          ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: (_selectedPeriod == 0
                        ...
                        .map((label) => Text(
                              label,
                              style: TextStyle(fontSize: 11, color: AppTheme.getMutedTextColor(context)),
                            ))
                        .toList(),
                  ),
                ],
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.end,
                          children: [
                            Text('14 min', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w700, color: AppTheme.getTextColor(context))),
                        ...
                        const SizedBox(height: 4),
                        Text('Compared to last week', style: TextStyle(fontSize: 12, color: AppTheme.getMutedTextColor(context))),
                      ],
                    ),
                  ),
                ],
  ...
  Widget _buildMetricCard(String label, String value, String change, bool isPositive) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(label, style: TextStyle(fontSize: 12, color: AppTheme.getMutedTextColor(context))),
          const SizedBox(height: 8),
          Row(
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [
              Text(value, style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: AppTheme.getTextColor(context))),
              const SizedBox(width: 8),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(label, style: TextStyle(fontSize: 14, color: AppTheme.getMutedTextColor(context))),
          const Spacer(),
          Text(value, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppTheme.getTextColor(context))),
        ],
      ),
    );
  }
  ...
  Widget _buildVisitorBar(String day, double ratio, int count) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.end,
      children: [
        Text('$count', style: TextStyle(fontSize: 9, fontWeight: FontWeight.w600, color: AppTheme.getMutedTextColor(context))),
        const SizedBox(height: 4),
        Container(
          width: 24,
          height: 100 * ratio,
        ...
        const SizedBox(height: 6),
        Text(day, style: TextStyle(fontSize: 10, color: AppTheme.getMutedTextColor(context))),
      ],
    );
  }
}
