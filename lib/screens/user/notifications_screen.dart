      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            if (hasUnread)
              TextButton(
                ...
                child: const Text('Mark All Read', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppTheme.accentColor)),
              ),
          ...
          bottom: TabBar(
            ...
            isScrollable: true,
            labelColor: theme.brightness == Brightness.dark ? Colors.white : AppTheme.primaryColor,
            unselectedLabelColor: theme.hintColor,
            labelStyle: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700),
            indicatorColor: theme.brightness == Brightness.dark ? AppTheme.accentColor : AppTheme.primaryColor,
            indicatorWeight: 3,
            tabAlignment: TabAlignment.start,
            tabs: const [
              Tab(text: 'All Activity'),
              Tab(text: 'Appointments'),
              Tab(text: 'Queue Updates'),
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Icon(Icons.notifications_off_outlined, size: 40, color: theme.hintColor),
                            ),
                            const SizedBox(height: 16),
                            Text('No Notifications', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: theme.textTheme.bodyLarge?.color)),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Dismissible(
                          ...
                          background: Container(
                            ...
                            child: const Icon(Icons.check_circle_rounded, color: AppTheme.successColor),
                          ),
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: n.isRead ? theme.cardColor : AppTheme.primaryColor.withOpacity(0.08),
                                borderRadius: BorderRadius.circular(18),
                                border: Border.all(color: n.isRead ? theme.dividerColor : AppTheme.primaryColor.withOpacity(0.2)),
                              ),
                              child: Row(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          n.body,
                                          style: TextStyle(fontSize: 13, color: theme.textTheme.bodyMedium?.color, height: 1.3),
                                          maxLines: 2,
