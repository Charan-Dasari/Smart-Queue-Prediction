...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      child: Scaffold(
        ...
        body: Stack(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildToggleMenuItem(Icons.dark_mode_outlined, 'Dark Mode', 'Switch to dark theme', _darkMode, (val) {
                          ...
                          AppTheme.setUserTheme(userId, val);
          ...
          const Positioned(
            ...
            right: 24,
            bottom: 16,
            child: FloatingCapsuleNavBar(currentIndex: 3),
          ),
        ],
      ),
    ),
  ...
  Widget _buildStatCard(String value, String label, Color color) {
    ...
    return Container(
      padding: EdgeInsets.symmetric(vertical: isNarrow ? 14 : 18),
      decoration: BoxDecoration(
      ...
      child: Column(
        children: [
          Text(value, style: TextStyle(fontSize: isNarrow ? 18 : 22, fontWeight: FontWeight.w700, color: color)),
          SizedBox(height: isNarrow ? 2 : 4),
          Text(label, style: TextStyle(fontSize: isNarrow ? 10 : 11, color: AppTheme.textMutedColor)),
        ],
      ),
    );
  }
