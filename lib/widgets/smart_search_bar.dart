...
class _SmartSearchBarState extends State<SmartSearchBar>
  ...
  static const List<Map<String, dynamic>> _trendingItems = [
    ...
    {'label': 'Delhi University', 'category': 'College', 'icon': Icons.school},
  ];
  ...
  OverlayEntry _buildOverlayEntry() {
    ...
    return OverlayEntry(
      builder: (ctx) => Stack(
        children: [
          // Dimmed backdrop dismiss barrier
          Positioned.fill(
  ...
  Widget _buildDropdown(BuildContext ctx) {
    ...
    final bgColor = isDark ? const Color(0xFF1A1730) : Colors.white;
    final borderCol = isDark ? const Color(0xFF2A2645) : AppTheme.borderColor;
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(20),
                border: Border.all(
                  color: isSelected ? color : (isDark ? const Color(0xFF2A2645) : AppTheme.borderColor),
        ...
        child: Row(
          children: [
            Container(
              width: 32, height: 32,
              decoration: BoxDecoration(
                color: isDark ? const Color(0xFF2A2645) : const Color(0xFFF3F1FA),
        ...
        child: ClipRRect(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIconConstraints: const BoxConstraints(minWidth: 44, maxHeight: 44),
              prefixIcon: Padding(
                ...
                child: _controller.text.isNotEmpty
                    ? InkWell(
                        ...
                        child: const Padding(
                          ...
                          child: Icon(Icons.close_rounded, size: 18, color: AppTheme.textLightColor),
                        ),
                      )
                    : GestureDetector(
