        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrowdLevel = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    TodayCustomers = table.Column<int>(type: "integer", nullable: false),
                    AvgServiceMinutes = table.Column<int>(type: "integer", nullable: false),
                    ProviderId = table.Column<Guid>(type: "uuid", nullable: false),
                    StaffUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    ActiveTokenId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
