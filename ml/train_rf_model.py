...
def train_and_save_rf_model():
    ...
    print("Random Forest Training R2 score:", rf_model.score(X_train_scaled, y_train))
    print("Random Forest Test R2 score:", rf_model.score(scaler.transform(X_test), y_test))
    ...
    print("Done! Random Forest Model and metadata saved to ml/models/")
